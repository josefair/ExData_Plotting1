...
##Plot 2, This plot will produce a graph for Global Active Power against time.  As output will create the plot2.png file.
  
  png(filename="plot2.png", width = 480, height = 480, units = "px")
  plot(dataset.sub$date_time, as.numeric(as.character(dataset.sub$Global_active_power)), type = "l", ylab= "Global Active Power (kilowatts)", xlab="")
  dev.off()
